...
gsap.from('.about-me-title', {duration: 1, y: 50, opacity: 0, delay: 0.5, ease: 'power4.out', stagger: 0.3});
gsap.from('.about-me-text', {duration: 1, y: 50, opacity: 0, delay: 0.5, ease: 'power4.out', stagger: 0.3});
